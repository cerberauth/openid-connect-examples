# TanStack Start App using Authorization Code Flow with PKCE

This project demonstrates how to implement the Authorization Code Flow with PKCE for a [TanStack Start](https://tanstack.com/start) application, built in SPA mode.
...
2. Install the dependencies:
  ...
  ```bash
  cd openid-connect-examples/examples/tanstack-start-app
  npm ci
  ```
...
4. Update the configuration:
  ...
  - Create a `.env.local` file in the root directory of your project or copy the `.env` file.
  - Add the necessary environment variables to the `.env.local` file. For example:
    ...
    Replace `https://your-oidc-provider.com` and `your-client-id` with the actual values provided by your OpenID Connect provider.
...
8. After successful authentication, you will be redirected back to the app and the user information will be displayed.
