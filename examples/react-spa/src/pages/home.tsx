    ...
    <div className="bg-surface min-h-screen">
      <main role="main" className="flex flex-col items-center justify-center h-5/6 space-y-8 text-center px-4 py-16 lg:pt-32 md:pt-16 sm:pt-8">
        ...
        <p className="mt-4 max-w-lg text-on-surface-variant">
          If you want to checkout out how to implement OpenID Connect in your React SPA, take a look at the <a className="text-primary" href="https://github.com/cerberauth/openid-connect-examples/tree/main/examples/react-spa">source code</a>.
        </p>
      </main>
