        ...
        <div className="bg-slate-100 min-h-screen">
          <main role="main" className="flex flex-col items-center justify-center h-5/6 space-y-8 text-center px-4 py-16 lg:pt-32 md:pt-16 sm:pt-8">
            ...
            <p className="mt-4 max-w-lg text-slate-700">
              If you want to checkout out how to implement OpenID Connect in your Hono app, take a look at the <a className="text-indigo-600" href="https://github.com/cerberauth/openid-connect-examples/tree/main/examples/hono-app">source code</a>.
            </p>
          </main>
