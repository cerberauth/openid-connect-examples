  ...
  <div class="bg-surface min-h-screen">
    <main role="main"
      ...
      <div class="max-w-lg rounded-lg border border-border bg-card p-6 shadow-sm flex flex-col items-center space-y-8 text-center">
        ...
        <button data-testid="logout-button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium h-10 px-4 py-2 bg-primary text-primary-fg hover:bg-primary/90" v-if="isAuthenticated" @click="logout">
          Logout
        </button>
